    ...
    (
        ...
        return (
            <button
                ...
                className={cn(
                    "group relative z-0 flex cursor-pointer items-center justify-center overflow-hidden whitespace-nowrap border border-white/5 px-6 py-3 text-white [background:var(--bg)] [border-radius:var(--radius)] dark:text-black",
