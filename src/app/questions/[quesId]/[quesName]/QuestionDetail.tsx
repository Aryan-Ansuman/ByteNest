    ...
    return (
        <div className="min-h-screen bg-[#080808] text-zinc-100">
            ...
            <div className="mx-auto flex max-w-[1440px]">
                    ...
                    <div className="mt-8 rounded-xl border border-white/10 bg-white/[0.03] p-4">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between text-xs">
                                ...
                                <span className="text-zinc-300">{convertDateToRelativeTime(new Date(question.$createdAt))}</span>
                            </div>
                            <div className="flex items-center justify-between text-xs">
                                <span className="text-zinc-500">Votes</span>
                                <span className="text-zinc-300">{questionVoteResult}</span>
                            </div>
                            <div className="flex items-center justify-between text-xs">
                                <span className="text-zinc-500">Answers</span>
                                <span className="text-zinc-300">{answers.total}</span>
                            </div>
                            <div className="flex items-center justify-between text-xs">
                ...
                {/* ── Main Content ── */}
                <main className="w-full px-4 pb-24 pt-8 md:px-8 lg:ml-60 lg:px-10">
                    ...
                    <Input
                        ...
                        onKeyDown={(e) => {
                            if (e.key === "Enter" && e.currentTarget.value.trim()) {
                                window.location.href = `/questions?search=${encodeURIComponent(e.currentTarget.value.trim())}`;
                            }
                        }}
                    />
                </div>
