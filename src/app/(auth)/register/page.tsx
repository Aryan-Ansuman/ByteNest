                ...
                <div className="flex min-h-full flex-col items-center py-12 px-6 sm:px-12 lg:px-16">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="flex gap-4">
                            <div className="space-y-1.5 flex-1">
                                ...
                                <div className="relative">
                                    <IconUser size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-zinc-500" />
                                    <Input
                                        type="text"
                                        placeholder="John"
                                        value={firstname}
                        ...
                        <Button
                            type="submit"
                            disabled={isLoading}
                            className="mt-6 h-11 w-full rounded-xl border border-[#a7c8b3]/20 bg-[#a7c8b3] font-semibold text-[#08100b] shadow-none transition-colors hover:bg-[#b4d6bf]"
                        >
                    ...
                    <p className="mt-8 text-center text-sm text-zinc-500">
                        ...
                        <Link href="/login" className="font-medium text-[#a7c8b3] hover:underline">
                            Login
                        </Link>
                    </p>
