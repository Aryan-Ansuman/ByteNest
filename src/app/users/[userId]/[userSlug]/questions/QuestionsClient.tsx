...
export default function QuestionsClient({
    ...
    return (
        <div className="min-h-screen bg-[#080808] text-zinc-100">
            <TopNav isOwnProfile={isOwnProfile} />
                            ...
                            <div className="space-y-0.5">
                                {tagFilter && (
                                    <button
                                        ...
                                        className="flex h-8 w-full items-center justify-between gap-2 rounded-lg px-3 text-xs text-[#a7c8b3] transition hover:bg-white/[0.05]"
                                    >
                                        <span className="flex items-center gap-2">
                                            <Hash className="size-3 text-[#a7c8b3]" />
                                            {tagFilter}
                                        </span>
                                ...
                                {allTags
                                    ...
                                    .map(([tag, count]) => (
                                        <button
                                            ...
                                            className="flex h-8 w-full items-center justify-between gap-2 rounded-lg px-3 text-xs text-zinc-500 transition hover:bg-white/[0.05] hover:text-zinc-300"
                                        >
                                            <span className="flex items-center gap-2">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="mt-2 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    {/* ── Ask question button (own profile) ── */}
                                    {isOwnProfile && (
                                        <Button
                                            asChild
                                            className="h-10 rounded-xl border border-[#a7c8b3]/20 bg-[#a7c8b3] px-4 text-sm font-medium text-[#08100b] shadow-none transition hover:bg-[#b4d6bf]"
                                        >
...
function TopNav({ isOwnProfile }: { isOwnProfile: boolean }) {
    return (
